    ...
    <div style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; color: #333;">
      <div style="max-width: 600px; margin: auto; background: #ffffff; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); overflow: hidden;">
        ...
        <div style="background: #6b22a4; padding: 20px; text-align: center;">
          <img src="https://indocsmedia.onrender.com/assets/logo.webp" alt="Indocs Media" style="max-height: 70px;" />
        </div>
        ...
        <div style="padding: 30px; text-align: center;">
          ...
          <div style="margin-top: 30px; text-align: center;">
            ...
            <a href="https://indocsmedia.onrender.com" target="_blank" style="display: inline-block; color: #6b22a4; text-decoration: underline; margin-left: 20px; font-size: 14px; font-weight: bold;">
              Visit Website
            </a>
          </div>
        </div>
